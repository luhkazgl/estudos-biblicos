...
export const BOOKS: Book[] = [
  // Antigo Testamento
  { id: 'genesis', name: 'Gênesis', testament: 'old', description: 'O livro dos começos, detalhando a criação, a queda do homem e o início da nação de Israel.', chapters: 50 },
  { id: 'exodo', name: 'Êxodo', testament: 'old', description: 'Narra a libertação de Israel da escravidão no Egito e a entrega da Lei no Monte Sinai.', chapters: 40 },
  { id: 'salmos', name: 'Salmos', testament: 'old', description: 'Uma coleção de 150 cânticos, orações e poemas que expressam a fé e as emoções do povo de Israel.', chapters: 150 },
  { id: 'proverbios', name: 'Provérbios', testament: 'old', description: 'Um livro de sabedoria que oferece conselhos práticos para a vida cotidiana.', chapters: 31 },
