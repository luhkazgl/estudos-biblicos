...
export const books: Book[] = [
  ...
  // Novo Testamento
  { id: 'mateus', name: 'Matues', testament: 'new', description: 'Um Evangelho enraizado nas Escrituras, que revela Jesus como o Rei prometido e Messias esperado.', details: 'studies/mateus/mateus-details.md', chapters: 28 },
