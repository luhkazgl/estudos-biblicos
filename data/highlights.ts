...
export const highlights: Highlight[] = [
  {
    ...
    verses: [
      {
        reference: '3:16-17',
        text: 'Porque Deus amou o mundo de tal maneira que deu o seu Filho unigênito, para que todo aquele que nele crê não pereça, mas tenha a vida eterna. Porque Deus enviou o seu Filho ao mundo, não para que condenasse o mundo, mas para que o mundo fosse salvo por ele.',
        commentary: 'Esse texto é a pregação do evangelho (as boas-novas), declara que Deus encarnou como homem (Jesus) para sofrer a penalidade da nossa culpa, em nosso lugar, revelando o amor de Deus para sua criação através da salvação imerecida por Deus, Cristo Jesus.'
      },
      {
        reference: '14:6',
        text: 'Disse-lhe Jesus: Eu sou o caminho, e a verdade e a vida, ninguém vem ao Pai, senão por mim',
        commentary: 'A declaração clara de Quem Jesus É, o único caminho, a única verdade e a única vida. Que a única possibilidade de salvação é por Jesus.'
      }
    ]
  },
  {
